 ...
 *      access.
 */
public class ApachePOIExcelRead_066 {
	...
	public static void main(String[] args) {
		...
		for(String [] temp : new ApachePOIExcelRead_066().getExcelContent(fileName,"test",START_ROW, START_COL, TOTAL_ROWS, TOTAL_COLUMNS))
		{
			for(String  tt : temp){
				if (tt !=null) {
