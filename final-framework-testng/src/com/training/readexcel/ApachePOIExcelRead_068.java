 ...
 *      access.
 */
public class ApachePOIExcelRead_068 {
	...
	public static void main(String[] args) {
		...
		for(String [] temp : new ApachePOIExcelRead_068().getExcelContent(fileName,"testdata068",START_ROW, START_COL, TOTAL_ROWS, TOTAL_COLUMNS))
		{
			for(String  tt : temp){
				if (tt !=null) {
